...
| Файл | Назначение |
|------|------------|
| [ARACHNE_X_FRONTEND_CONTRACT.md](./ARACHNE_X_FRONTEND_CONTRACT.md) | Контракт: токен, WebSocket, HTTP-чат, CORS, типы `ArachineXEvent` |
...
| [bruno/](./bruno/) | Коллекция Bruno (mint token, chat stub) |
